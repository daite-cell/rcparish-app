const navItems = [
	...
	{ label: 'PROPERTIES', to: '/properties/rent_details' },
	{ label: 'ACCOUNTING', to: '/accounting/subscription' },
	{ label: 'HOUSES', to: '/houses/institutions' },
	{ label: 'COMMON POOL', to: '/common_pool/search_family' },
];
