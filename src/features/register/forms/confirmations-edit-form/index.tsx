...
import { confirmationsEditSchema, type ConfirmationsEditType } from '../../validations';
import { activenessOptions, genderOptions, subStationOptions } from '@/forms-options-data';

const ConfirmationsEditForm = () => {
	const {
		control,
		handleSubmit,
		formState: { errors },
	} = useForm<ConfirmationsEditType>({
		resolver: zodResolver(confirmationsEditSchema),
		defaultValues: {
	...
	const onSubmit = (data: ConfirmationsEditType) => {
			...
			<div className="flex flex-wrap w-full gap-4">
				...
				<div className="flex-1 w-full p-5 space-y-5 border border-gray-300 rounded-md">
					...
					<CustomFormInput
						control={control}
						name="godMotherName"
						label="Godmother's Name (optional)"
...
export default ConfirmationsEditForm;
